...
const struct low_power_param power_param = {
    ...
    //.rtc_clk        = CLK_SEL_LRC,        // Mike Wen Added
};
...
RTC_DEV_PLATFORM_DATA_BEGIN(rtc_data)
    ...
    //.clk_sel =  CLK_SEL_LRC,    // Mike Wen Added
...
{
#if TCFG_UART0_ENABLE
#if TCFG_UART0_RX_PORT==IO_PORT_DM
    gpio_direction_input(TCFG_UART0_RX_PORT);
    gpio_set_pull_up(TCFG_UART0_RX_PORT,1);
    gpio_set_die(TCFG_UART0_RX_PORT,1);
    gpio_set_fun_input_port(TCFG_UART0_RX_PORT, PFI_UART0_RX);
#endif
